...
public:
	...
	bool CreateConnPool(std::string& strErrMsg, std::string& strErrDesc, const char* szPoolName, const char* szHost, const char* szDatabase, const char* szUser, const char* szPassword, unsigned int nPort=3306, const char* szActiveSql="SELECT 1"/*激活语句*/, int nTimeOut=60, bool bUseUtf8=false, int nMinSize=2, int nMaxSize=5);
