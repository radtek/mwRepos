...
void UTILITY_Export GetMD5(unsigned char* pBuf, unsigned int nLength, unsigned char* pMD5);

void UTILITY_Export Md5ToHexStr(const unsigned char* pMD5, unsigned int nLength, char* szHexStr);

//RSA MD5 implementation
void UTILITY_Export InitMd5Var(unsigned char* m_lpszBuffer, unsigned int* m_nCount, unsigned int* m_lMD5);
void UTILITY_Export Transform(unsigned char Block[64], unsigned int* m_lMD5);
void UTILITY_Export Update(unsigned char* Input, unsigned int nInputLen, unsigned int* m_nCount, unsigned char* m_lpszBuffer, unsigned int* m_lMD5);
void UTILITY_Export Final(unsigned char *strMD5, unsigned int* m_nCount, unsigned int* m_lMD5, unsigned char *m_lpszBuffer);
inline unsigned int UTILITY_Export RotateLeft(unsigned int x, int n);
inline void UTILITY_Export FF(unsigned int& A, unsigned int B, unsigned int C, unsigned int D, unsigned int X, unsigned int S, unsigned int T);
inline void UTILITY_Export GG(unsigned int& A, unsigned int B, unsigned int C, unsigned int D, unsigned int X, unsigned int S, unsigned int T);
inline void UTILITY_Export HH(unsigned int& A, unsigned int B, unsigned int C, unsigned int D, unsigned int X, unsigned int S, unsigned int T);
inline void UTILITY_Export II(unsigned int& A, unsigned int B, unsigned int C, unsigned int D, unsigned int X, unsigned int S, unsigned int T);

//utility functions
void UTILITY_Export DWordToByte(unsigned char* Output, unsigned int* Input, unsigned int nLength);
void UTILITY_Export ByteToDWord(unsigned int* Output, unsigned char* Input, unsigned int nLength);

//RSA MD5 implementation
// void InitMd5Var(BYTE* m_lpszBuffer, ULONG* m_nCount, ULONG* m_lMD5);
// void Transform(BYTE Block[64], ULONG* m_lMD5);
// void Update( BYTE* Input,	ULONG nInputLen, ULONG* m_nCount, BYTE* m_lpszBuffer, ULONG* m_lMD5);
// void Final(BYTE *strMD5, ULONG* m_nCount, ULONG* m_lMD5, BYTE *m_lpszBuffer);
