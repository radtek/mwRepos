...
ODBC_SQLCONNECTION_NSAMESPACE::CSQLConnection::CSQLConnection()
   : ODBC_SQLBASE_NSAMESPACE::CSQLBase(NULL),m_hEnv(NULL)//,m_hStmt(NULL)
{
...
bool ODBC_SQLCONNECTION_NSAMESPACE::CSQLConnection::Open(const char* szHost,
...
void ODBC_SQLCONNECTION_NSAMESPACE::CSQLConnection::Close()
{
	try
	{
		/*  if (NULL != m_hStmt)
...
bool ODBC_SQLCONNECTION_NSAMESPACE::CSQLConnection::IsOpen()
{
   return (NULL != m_hCon);
}
