...
bool DBConnection::Open(const char* szHost, const char* szDatabase, const char* szUser, const char* szPassword, unsigned int nPort, bool bUseUtf8)
{
    return (bValid = sqlconn.Open(szHost,szDatabase,szUser,szPassword,nPort, bUseUtf8));
}
