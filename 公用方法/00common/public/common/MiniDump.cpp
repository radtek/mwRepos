...
// If Show_Flag = TRUE - show message with Get_Exception_Info() dump.
{
	...
	strTXTFile.Format(_T("%s\\%04d-%02d-%02d %02d-%02d-%02d-%03d.txt"),GetExePath(),t.wYear,t.wMonth,t.wDay,t.wHour,t.wMinute,t.wSecond,t.wMilliseconds);
	strDMPFile.Format(_T("%s\\%04d-%02d-%02d %02d-%02d-%02d-%03d.dmp"),GetExePath(),t.wYear,t.wMonth,t.wDay,t.wHour,t.wMinute,t.wSecond,t.wMilliseconds);
...
/*
	异常处理
*/
LONG WINAPI GPTUnhandledExceptionFilter(LPEXCEPTION_POINTERS ExceptionInfo)
{
	char	szFileName[MAX_PATH] = {0x00};

	// 重启程序
	::GetModuleFileName(NULL, szFileName, MAX_PATH);
	//int nRet = WinExec(szFileName, SW_SHOW);
