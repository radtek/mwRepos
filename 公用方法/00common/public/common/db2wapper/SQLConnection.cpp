...
DB2_SQLCONNECTION_NSAMESPACE::CSQLConnection::CSQLConnection()
   : DB2_SQLBASE_NSAMESPACE::CSQLBase(NULL),m_hEnv(NULL)//,m_hStmt(NULL)
{
...
bool DB2_SQLCONNECTION_NSAMESPACE::CSQLConnection::Open(const char* szHost,
...
void DB2_SQLCONNECTION_NSAMESPACE::CSQLConnection::Close()
{
/*  if (NULL != m_hStmt)
    {
...
bool DB2_SQLCONNECTION_NSAMESPACE::CSQLConnection::IsOpen()
{
   return (NULL != m_hCon);
}
