#ifndef __ORACLE_SQLVALUE_H__
#define __ORACLE_SQLVALUE_H__

#include "SQLTypes.h"

namespace ORACLE_SQLVALUE_NSAMESPACE {
...
public:
    CSQLValue();
    CSQLValue(const char* pData, unsigned long nLength, oracle::occi::Type eType=OCCI_SQLT_BLOB);
...
public:
    ...
    inline oracle::occi::Type GetType() const
    {
        return m_eType;
    }
