#ifndef __DB2_SQLVALUE_H__
#define __DB2_SQLVALUE_H__

#include "SQLTypes.h"

namespace DB2_SQLVALUE_NSAMESPACE {
...
public:
    CSQLValue();
    CSQLValue(const char* pData, unsigned long nLength, DB2_SQLTYPES_NSAMESPACE::Type eType=SQL_CHAR);
    CSQLValue(const CSQLValue& rValue);
    virtual ~CSQLValue();
protected:
    char* m_pData;
    unsigned long m_nLength;
    DB2_SQLTYPES_NSAMESPACE::Type   m_eType;
public:
    ...
    inline DB2_SQLTYPES_NSAMESPACE::Type GetType() const
    {
        return m_eType;
    }
