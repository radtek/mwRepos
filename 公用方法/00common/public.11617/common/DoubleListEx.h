...
public:
    ...
    void                RecyleIdleMem();
    T*                  FindKey(int nKey);
	T					GetKeyData(int nKey);
    T*                  GetBlank(int& nKey);
    T*                  GetBlank();
    void                RemoveAt(int nKey);
    void                RemoveAtEx(int nKey);
    T*                  GetHead();
    T*                  GetNext(int nKey);
...
T* CDoubleListEx<T,COUNT>::GetBlank()
{
    ...
    try
    {
        ...
        {
            //若该地址不存在则加入队列
            if (m_InUse.find((int)lp_t) == m_InUse.end())
            {
                //memset(lp_t, 0, sizeof(T));
                m_InUse.insert(std::make_pair((int)lp_t, lp_t));
            }
        }
    }
    catch (...)
...
---------------------------------------------------------------------------------*/
template<class T,int COUNT>
void CDoubleListEx<T,COUNT>::RemoveAt(int nKey)
{
    SafeLock safelock(&m_cs);
...
---------------------------------------------------------------------------------*/
template<class T,int COUNT>
void CDoubleListEx<T,COUNT>::RemoveAtEx(int nKey)
{
    SafeLock safelock(&m_cs);
...
---------------------------------------------------------------------------------*/
template<class T,int COUNT>
T* CDoubleListEx<T,COUNT>::FindKey(int nKey)
{
    SafeLock safelock(&m_cs);
...
---------------------------------------------------------------------------------*/
template<class T,int COUNT>
T CDoubleListEx<T,COUNT>::GetKeyData(int nKey)
{
	SafeLock safelock(&m_cs); 
...
---------------------------------------------------------------------------------*/
template<class T,int COUNT>
T* CDoubleListEx<T,COUNT>::GetNext(int nKey)
{
    SafeLock safelock(&m_cs);
...
---------------------------------------------------------------------------------*/
template<class T,int COUNT>
int CDoubleListEx<T,COUNT>::GetNextKey(int nKey)
{
	SafeLock safelock(&m_cs); 
...
---------------------------------------------------------------------------------*/
template<class T,int COUNT>
int CDoubleListEx<T,COUNT>::GetHeadKey()
{
    SafeLock safelock(&m_cs);
